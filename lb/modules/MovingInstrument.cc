...
void LB_MovingInstrument_i::xyz_to_xy(double tx,
                                      double ty,
                                      double tz,
                                      long& outx,
                                      long& outy)
{
  ...
  double phi=
    acos((pow(sidea,
              2) + pow(sideb, 2) - pow(sidec, 2)) / (2 * sidea * sideb));
...
void LB_MovingInstrument_i::setTarget(CORBA::Double x,
                                      CORBA::Double y,
                                      CORBA::Double z)
{
  long outx, outy;
...
void LB_MovingInstrument_i::getTarget(CORBA::Double& x,
                                      CORBA::Double& y,
                                      CORBA::Double& z)
{}
